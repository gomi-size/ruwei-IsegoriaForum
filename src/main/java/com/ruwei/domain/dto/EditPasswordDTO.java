 ...
 *
 * <p><b>邮箱验证</b>：在登录态之外新增 {@link #code} —— 需先向<b>当前绑定邮箱</b>
 * 发送 {@code EmailScene.CHANGE_PASSWORD}(changePwd) 场景验证码。邮箱由服务端
 * 从登录态读取，前端不传也不能指定，防止校验被指向他人邮箱。</p>
 *
...
public class EditPasswordDTO {
    ...
    /**
     * 邮箱验证码（必填）：发送至当前绑定邮箱，场景 changePwd
     */
    private String code;
}
